...
namespace JobChannel.BLL.Services.DepartmentServices
{
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<IEnumerable<Department>> GetAllDepartments() => await _departmentRepository.GetAllDepartments();

        public async Task<IEnumerable<DepartmentGetResponse>?> GetByRegionId(int regionId) => await _departmentRepository.GetDepartmentsByRegionId(regionId);
    }
}
